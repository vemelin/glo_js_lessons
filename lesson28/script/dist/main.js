...
/* harmony import */ var formdata_polyfill__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! formdata-polyfill */ "../../node_modules/formdata-polyfill/formdata.min.js");
...
/* harmony import */ var fetch_polyfill__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! fetch-polyfill */ "./node_modules/fetch-polyfill/fetch.js");
/* harmony import */ var fetch_polyfill__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(fetch_polyfill__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _modules_countTimer__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/countTimer */ "./lesson28/script/modules/countTimer.js");
/* harmony import */ var _modules_toggleMenu__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/toggleMenu */ "./lesson28/script/modules/toggleMenu.js");
/* harmony import */ var _modules_smoothScroll__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/smoothScroll */ "./lesson28/script/modules/smoothScroll.js");
/* harmony import */ var _modules_modalWindow__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/modalWindow */ "./lesson28/script/modules/modalWindow.js");
/* harmony import */ var _modules_ourServiceBlock__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/ourServiceBlock */ "./lesson28/script/modules/ourServiceBlock.js");
/* harmony import */ var _modules_imageSlider__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/imageSlider */ "./lesson28/script/modules/imageSlider.js");
/* harmony import */ var _modules_formValidation__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/formValidation */ "./lesson28/script/modules/formValidation.js");
/* harmony import */ var _modules_ourTeamBlock__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modules/ourTeamBlock */ "./lesson28/script/modules/ourTeamBlock.js");
/* harmony import */ var _modules_calculatorBlock__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./modules/calculatorBlock */ "./lesson28/script/modules/calculatorBlock.js");
/* harmony import */ var _modules_ajaxRequest__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./modules/ajaxRequest */ "./lesson28/script/modules/ajaxRequest.js");
 // Polyfills 
...
Object(_modules_countTimer__WEBPACK_IMPORTED_MODULE_5__["default"])("21 april 2020"); // Main navigation


Object(_modules_toggleMenu__WEBPACK_IMPORTED_MODULE_6__["default"])(); // Main slow mo


Object(_modules_smoothScroll__WEBPACK_IMPORTED_MODULE_7__["default"])(); // Modal window


Object(_modules_modalWindow__WEBPACK_IMPORTED_MODULE_8__["default"])(); // Our Services block


Object(_modules_ourServiceBlock__WEBPACK_IMPORTED_MODULE_9__["default"])(); // Portfolio Image Slider Scroll


Object(_modules_imageSlider__WEBPACK_IMPORTED_MODULE_10__["default"])(); // Form validation


Object(_modules_formValidation__WEBPACK_IMPORTED_MODULE_11__["default"])(); // Our team block


Object(_modules_ourTeamBlock__WEBPACK_IMPORTED_MODULE_12__["default"])(); // Interior calculator block


Object(_modules_calculatorBlock__WEBPACK_IMPORTED_MODULE_13__["default"])(100); // Send Form through AJAX function


Object(_modules_ajaxRequest__WEBPACK_IMPORTED_MODULE_14__["default"])();
...
var sendForm = function sendForm() {
  ...
  statusMessage.style.cssText = "font: normal 2rem Roboto; color: white;"; // statusMessage.textContent = 'Statu Message Text Goes Here';
  // Parse all forms and went through event handler

  forms.forEach(function (form) {
    form.addEventListener("submit", function (event) {
      event.preventDefault();
      form.appendChild(statusMessage); // After click on send CTA show >> Loading message...
      ...
      var outputData = function outputData() {
        statusMessage.textContent = successMessage; // Clear all inputs after message was sent
...
var calculatorBlock = function calculatorBlock() {
  ...
  var getBlockElement = document.querySelector(".calc-block"),
      ...
      getTotalElement = document.getElementById("total"); // Run number slow motion

  var runNumber = function runNumber(input) {
    var interval,
        start = 0;
    ...
    var step = 50000; // seconds = 1;
    // let setTime = Math.round((seconds/(input/step))/1000);

    var setTime = Math.round(input / step / 1000);
  ...
  var addition = function addition() {
    var amount = 0,
        dayValue = 1,
        roomValue = 1;
    var addValue = getTypeElement.options[getTypeElement.selectedIndex].value,
  ...
  getBlockElement.addEventListener("change", function (event) {
    var target = event.target;
...
/***/ "./lesson28/script/modules/formValidation.js":
/*!***************************************************!*\
  !*** ./lesson28/script/modules/formValidation.js ***!
  \***************************************************/
/*! exports provided: default */
...
var modalToggle = function modalToggle() {
  ...
  modalCTA.forEach(function (output) {
    return output.addEventListener("click", modalSlowMo);
  });
