...
domElement.prototype.addNewElements = function () {
  ...
  switch (inputText) {
    ...
    case '.':
      ...
      div.style.cssText = 'height: 50vh; width: 50vh; background: green; font-size: 50px; color:white';
    ...
    case'#':
      ...
      p.style.cssText = 'height: 50vh; width: 50vh; background: red; font-size: 50px; color:white';
      p.textContent = 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Nisi sit error';
...
let newObject = new DomElement('.new_object', '70vh', '70vh', 'black', '35px');
